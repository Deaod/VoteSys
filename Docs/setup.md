...
* [VoteSys.ini](#votesysini)
* [VoteSysPresets.ini](#votesyspresetsini)
* [VoteSysMapLists.ini](#votesysmaplistsini)

In addition there are INI files that dont contain configuration, but are used to preserve data across map-changes:

* VoteSysTemp.ini
* VoteSysHistory.ini
* VoteSysBans.ini

If you want to switch between versions of ACE using VoteSys, finish reading this document, then read [this guide](ace.md).
