...
function ApplyTheme() {
	...
	Adt_InheritFrom.SetTheme(Theme);
	Edt_ServerName.Theme = Theme;
	Edt_Game.Theme = Theme;
	Edt_MapListName.Theme = Theme;
	Adt_Mutators.SetTheme(Theme);
	Adt_Parameters.SetTheme(Theme);
	Adt_GameSettings.SetTheme(Theme);
	Adt_Packages.SetTheme(Theme);
...
function EnableInteraction(bool bEnable) {
	...
	Adt_InheritFrom.SetEnabled(false);
	Edt_ServerName.EditBox.SetEditable(false);
	Edt_Game.EditBox.SetEditable(false);
	Edt_MapListName.EditBox.SetEditable(false);
	Adt_Mutators.SetEnabled(false);
	Adt_Parameters.SetEnabled(false);
	Adt_GameSettings.SetEnabled(false);
	Adt_Packages.SetEnabled(false);
...
function BeforePaint(Canvas C, float MouseX, float MouseY) {
	...
	if (SelectedPreset != PresetList.SelectedItem) {
		...
		Adt_InheritFrom.SetEnabled(SelectedPreset != none);
		...
		Adt_Mutators.SetEnabled(SelectedPreset != none);
		Adt_Parameters.SetEnabled(SelectedPreset != none);
		Adt_GameSettings.SetEnabled(SelectedPreset != none);
		Adt_Packages.SetEnabled(SelectedPreset != none);
